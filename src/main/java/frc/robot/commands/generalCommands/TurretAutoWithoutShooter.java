...
public class TurretAutoWithoutShooter extends Command {
  ...
  public TurretAutoWithoutShooter(Turret t, SwerveSubsystem s, Shooter ss, CommandXboxController c) {
    turret = t;
    swerve = s;
    shooter = ss;
    controller = c;
  ...
  public void initialize() {
    turret.getAimmer().setControlState(turretControlState.TURRETAUTO_SHOOTERMANUAL);
  }
